...
import { RotateCw, FileText, X, Receipt, Download } from 'lucide-react';
import type { Payment } from '../../context/SubscriptionContext';
  ...
  return (
    ...
    >
      ...
      <Card className="bg-black/20 border-white/5 overflow-hidden">
        <CardHeader>
          <CardTitle className="text-base font-heading">Payments & Transactions</CardTitle>
